select
  ...
  'S' || lpad(uniform(0, 9999, random())::string, 6, '0') as student_id,
  'C' || lpad(uniform(0, 299, random())::string, 4, '0') as course_id,
  'T' || lpad(uniform(0, 11, random())::string, 2, '0') as term_id,
